...
class MyColors {
 ...
 //Car Remote Colors
  static const carBackColorG1 = const  Color(0xff4e5160);
  static const carBackColorG11 = const  Color(0xff494c5a);
  static const carBackColorG12 = const  Color(0xff444755);
  static const carBackColorG2 = const  Color(0xff3f434f);
  static const carBackColorG21 = const  Color(0xff3a3e4a);

  static const carBackColorC1 = const  Color(0xff1f2021);
  static const carBackColorC11 = const  Color(0xff2c2d2e);
  static const carBackColorC12 = const  Color(0xff3a3a3b);
  static const carBackColorC2 = const  Color(0xff484849);
  static const carBackColorC21 = const  Color(0xff575757);

  static const carButtonColor = const  Color(0xff575b67);



  static const carMediaColor = const  Color(0xff3a3e4a);
